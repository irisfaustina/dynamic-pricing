//define subscription tiers and  organize them in order from free to premium

import stripe from "stripe"
import { env } from "./env/server"

//React component would be .tsx, but a file containing helper functions would be .ts
export type TierNames = keyof typeof subscriptionTiers /* grab tier names from subs below */
